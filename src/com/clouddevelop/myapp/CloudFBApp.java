 ...
 *
 *  Created by Cloud Hsu on 2013/4/19.
...
public class CloudFBApp extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		FacebookManager.getInstance().setMainActivity(this);
    ...
    public void onStart() {
        ...
        FacebookManager.getInstance().initial();
    }
    ...
    public void onStop() {
        ...
        FacebookManager.getInstance().uninitial();
    }
